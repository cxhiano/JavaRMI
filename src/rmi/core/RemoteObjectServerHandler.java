 ...
 * types, local objects, remote objects. Upon invoking, all parameters will
 * be checked. If a parameter is a remote object but it exists on localhost,
 * the handler will fetch the local object instead of using the original
 * remote object.
 *
